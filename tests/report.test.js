...
describe('formatSarif', () => {
    it('returns SARIF 2.1.0 with one result per entry', () => {
        ...
        expect(parsed.runs[0].results[0].locations[0].physicalLocation.artifactLocation.uri).toBe('a.js');
    });
});

describe('formatPdfMarkdown', () => {
    const meta = { projectDir: '/home/user/my-project', totalFiles: 10, dateString: '2026-06-09' };
