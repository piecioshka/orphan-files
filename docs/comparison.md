...
> Data current as of **2026-09-01**. Versions, publish dates, weekly downloads and repository status come from the npm registry (`registry.npmjs.org`), the npm downloads API and the GitHub API. Download counts are approximate and change over time.
...
\* `vite-plugin-unused-code`: in **Vite 8+** unused exports will no longer be reported (Rolldown tree-shaking); file detection remains.
...
- **Active:** knip (6.34.0, 2026-08), rev-dep (3.0.0, 2026-08), skott (0.35.11, 2026-04), find-unused-exports (9.0.0, 2026-06), vite-plugin-unused-code (0.1.8, 2026-03), eslint-plugin-unused-imports (4.4.1, 2026-02), dead-code-checker (1.1.0, 2025-07).
...
- **Dead / abandoned:** deadfile (2024), dead-files (niche), orphan (2016), delete-react-zombies (2022), webpack-deadcode-plugin (2022), unused-files-webpack-plugin (2018), webpack-unused (2016), rollup-plugin-unused (2021), unplugin-slim (repo 404).
