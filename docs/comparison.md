...
> Data current as of **2026-06-10**. Versions, publish dates, weekly downloads and repository
...
| **[knip](https://www.npmjs.com/package/knip)**                                 | 🗂️🔣📦       | **Reachability**            | ✅      | ✅ (strong)      | ✅ (files: `--allow-remove-files`) | json, markdown, codeowners, codeclimate, github-actions | 6.16.1 (2026-06)  | ~8.6M        | **active — market standard**     |
| **[rev-dep](https://www.npmjs.com/package/rev-dep)**                           | 🗂️🔣🕸️📦     | **Reachability**            | ✅      | ✅ (first-class) | ✅ `config run --fix`              | json, text                                              | 2.15.0 (2026-06)  | ~33k         | **most actively developed**      |
| **[skott](https://www.npmjs.com/package/skott)**                               | 🗂️🕸️📦       | **Reachability**            | ✅      | ✅ (partial)     | ❌                                 | webapp, json, mermaid                                   | 0.35.11 (2026-04) | ~87k         | active                           |
| **[deadfile](https://www.npmjs.com/package/deadfile)**                         | 🗂️           | **Reachability**            | ⚠️ weak | ❌               | ❌                                 | console, HTML report, json                              | 2.1.1 (2024-03)   | ~1.3k        | inactive ~2 yrs                  |
| **[dead-files](https://www.npmjs.com/package/dead-files)**                     | 🗂️           | ⚠️ `importedBy=0` heuristic | ✅      | ❌               | ✅ interactive                     | json                                                    | 0.1.2 (2026-03)   | ~10          | new, niche                       |
| **[next-unused](https://www.npmjs.com/package/next-unused)**                   | 🗂️ (Next.js) | Reachability (from `pages`) | ⚠️      | ❌               | ❌                                 | console                                                 | 0.0.6 (2021-03)   | ~14.5k       | **archived → knip**              |
| **[unimported](https://www.npmjs.com/package/unimported)**                     | 🗂️📦         | Reachability                | ✅      | ❌               | ✅ `--fix`                         | console                                                 | 1.31.1 (2023-11)  | ~96k         | **archived + deprecated → knip** |
...
- **next-unused** / **unimported** / **orphan** — historical, **abandoned**; the first two explicitly
  redirect to `knip`. `unimported` still sees ~96k downloads/wk (legacy in pipelines).
...
| ------------------------------------------------ | ------- | ------------------------------------------ | ----------------------------- | -------- | ----------------- | ------------ | ------------------- |
| **[madge](https://www.npmjs.com/package/madge)** | 🕸️🗂️    | ⚠️ isolated nodes (`--orphans`/`--leaves`) | dot, svg/png (Graphviz), json | ❌       | 8.0.0 (2024-08)   | **~2.5M**    | stable, slow-moving |
| **[skott](https://www.npmjs.com/package/skott)** | 🕸️🗂️📦  | Reachability                               | webapp, mermaid, json         | ❌       | 0.35.11 (2026-04) | ~87k         | active              |
...
| ---------------------------------------------------------------------------- | ------- | -------------------------------- | ------------ | ------- | ---------------- | ------------ | -------------------------- |
| **[tsr](https://www.npmjs.com/package/tsr)** (TypeScript Remove)             | 🔣🗂️💀  | ✅ + removes                     | ✅ `--write` | TS only | 1.3.4 (2025-01)  | ~34.5k       | **archived → knip**        |
| **[ts-unused-exports](https://www.npmjs.com/package/ts-unused-exports)**     | 🔣      | ⚠️ `--findCompletelyUnusedFiles` | ❌           | ✅      | 11.0.1 (2024-11) | ~288k        | moderate (no release ~1yr) |
| **[find-unused-exports](https://www.npmjs.com/package/find-unused-exports)** | 🔣      | ❌                               | ❌           | ✅      | 9.0.0 (2026-06)  | ~4.9k        | active (freshest)          |
| **[dead-code-checker](https://www.npmjs.com/package/dead-code-checker)**     | 💀      | ❌                               | ❌           | ✅      | 1.1.0 (2025-07)  | ~1.5k        | niche, maintained          |
...
| ---------------------------------------------------------------------------------------------- | ------- | ------------------------- | ----------------- | --------------- | ------------ | -------- |
| **[eslint-plugin-unused-imports](https://www.npmjs.com/package/eslint-plugin-unused-imports)** | 🧩      | static (ESLint, no build) | ✅ `eslint --fix` | 4.4.1 (2026-02) | **~8.9M**    | dominant |
| **[depcheck](https://www.npmjs.com/package/depcheck)**                                         | 📦      | heuristic                 | ❌                | 1.4.7 (2023-10) | ~1.84M       | archived |
...
| **[vite-plugin-unused-code](https://www.npmjs.com/package/vite-plugin-unused-code)**         | Vite/Rollup             | 🗂️🔣    | ✅          | ❌       | 0.1.8 (2026-03)  | ~8.3k        | active\*              |
...
- **Adoption / maturity:** knip (~8.6M/wk) and madge (~2.5M/wk) are ecosystems; `orphan-files` is new
...
- **Active:** knip (6.16.1, 2026-06), rev-dep (2.15.0, 2026-06), skott (0.35.11, 2026-04),
