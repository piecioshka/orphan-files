...
export const DEFAULT_CONFIG_BASENAME = "orphan-files.config";

// Resolves the default config file, trying each supported extension in turn.
// Returns the basename that exists, or null when the project has no config.
export function findDefaultConfig(cwd) {
